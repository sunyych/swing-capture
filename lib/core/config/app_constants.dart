class AppConstants {
  ...
  static const bool verbosePoseJsonLog = false;
  ...
  static const int rollingBufferTargetFps = 120;
  static const int rollingBufferFrameCapacity = 480;
  static const int rollingBufferDurationMs = 4000;
